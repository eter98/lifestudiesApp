...
import { IProgramas, Programas, Duraciond, TipoProgramad } from 'app/shared/model/programas.model';
...
describe('Service Tests', () => {
    describe('Programas Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Programas(0, 'AAAAAAA', Duraciond.UN_MES, TipoProgramad.Programas_Idiomas);
        });
