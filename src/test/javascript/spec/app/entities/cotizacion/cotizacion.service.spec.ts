...
describe('Service Tests', () => {
    describe('Cotizacion Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Cotizacion(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 0, 'AAAAAAA', currentDate);
        });
        ...
        describe('Service methods', async () => {
            it('should find an element', async () => {
                const returnedFromService = Object.assign(
                    {
                        fechaViaje: currentDate.format(DATE_FORMAT)
                    },
                    elemDefault
                );
                service
